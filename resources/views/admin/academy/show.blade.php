<x-admin-layout>
    <div class="container-xl py-4">
        {{-- Breadcrumb --}}
        <nav class="mb-3">
            <a href="{{ route('admin.academy.index') }}" class="text-muted text-decoration-none d-inline-flex align-items-center gap-1">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mb-0">Kelola modul dan materi pembelajaran</p>
            </div>
                ...
                <div class="card shadow-sm border-0" style="border-radius: 20px; position: sticky; top: 20px;">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('admin.academy.course.update', $course) }}" method="POST">
                            @csrf @method('PUT')
                            <div class="mb-3">
                                <label class="form-label fw-bold small text-uppercase text-muted">Judul E-Course</label>
