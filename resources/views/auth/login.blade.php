            ...
            <form action="{{ route('login') }}" method="POST" autocomplete="off" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-icon">
                        ...
                        <input type="email" name="email" class="form-control border-2 @error('email') is-invalid @enderror" placeholder="email@contoh.com" value="{{ old('email') }}" required autofocus style="border-radius: 10px;">
                    </div>
                    @error('email')
                ...
                <div class="mb-3">
                    <label class="form-label fw-bold">
                        ...
                        <span class="form-label-description">
                            <a href="{{ route('password.request') }}" class="text-primary fw-bold small">Lupa?</a>
                        </span>
                        @endif
                    </label>
                    <div class="input-group input-group-flat">
                        <input type="password" id="password" name="password" class="form-control border-2 @error('password') is-invalid @enderror" placeholder="Masukkan kata sandi" autocomplete="off" required style="border-radius: 10px 0 0 10px;">
                ...
                <div class="form-footer mt-4">
                    <button type="submit" class="btn btn-primary w-100 fw-bold py-3 shadow-sm hover-lift" style="border-radius: 12px; font-size: 1rem;">
                        Masuk Sekarang
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-right ms-2" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 12l14 0" /><path d="M13 18l6 -6" /><path d="M13 6l6 6" /></svg>
                    </button>
                </div>
            </form>
        </div>
