        ...
        <div class="sidebar-wrapper">
            <div class="collapse navbar-collapse sidebar-content" id="sidebar-menu">
                ...
                <ul class="nav-menu navbar-nav pt-lg-3">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.super.dashboard') }}" class="nav-link {{ request()->routeIs('admin.super.dashboard') || request()->routeIs('admin.super.traffic') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.academy.index') }}" class="nav-link {{ request()->routeIs('admin.academy.*') ? 'active' : '' }}">
